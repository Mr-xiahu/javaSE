...
//		System.out.println(map);
		...
		// System.out.println("put:"+map.put("1", " 张三"));
		map.put("刘备", "孙尚香");
		map.put("孙策", "大乔");
		map.put("周瑜", "小乔");
//		System.out.println(map);
		...
		//删除功能
		//V remove(Object key)：根据键删除键值对元素，并把值返回
		// System.out.println("remove:"+map.remove("孙策"));
		// System.out.println(map);
		
		//判断功能
		//boolean containsKey(Object key)：判断集合是否包含指定的键
		System.out.println("containsKey:"+map.containsKey("刘备"));
		System.out.println("containsKey:"+map.containsKey("关羽"));
		System.out.println("-------------------------------");
		
		//boolean containsValue(Object value):判断集合是否包含指定的值
		System.out.println("containsValue:"+map.containsValue("孙尚香"));
		System.out.println("containsValue:"+map.containsValue("黄月英"));
		System.out.println("-------------------------------");
